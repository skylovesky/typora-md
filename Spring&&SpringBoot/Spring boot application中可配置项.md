https://docs.spring.io/spring-boot/docs/2.3.0.M2/reference/htmlsingle/#common-application-properties

### 10.Appendices

Appendix A: Common Application properties](https://docs.spring.io/spring-boot/docs/2.3.0.M2/reference/htmlsingle/#common-application-properties)
...
| `spring.couchbase.env.endpoints.key-value`                   | `1.0`                        | Number of sockets per node against the key/value service.    |
| `spring.couchbase.env.endpoints.queryservice.max-endpoints`  | `1.0`                        | Maximum number of sockets per node.                          |
| `spring.couchbase.env.endpoints.queryservice.min-endpoints`  | `1.0`                        | Minimum number of sockets per node.                          |
| `spring.couchbase.env.endpoints.viewservice.max-endpoints`   | `1.0`                        | Maximum number of sockets per node.                          |
| `spring.couchbase.env.endpoints.viewservice.min-endpoints`   | `1.0`                        | Minimum number of sockets per node.                          |
...
| `spring.data.cassandra.contact-points`                       | `[127.0.0.1:9042]`           | Cluster node addresses in the form 'host:port'.              |
...
| `spring.data.cassandra.page-size`                            | `5000.0`                     | Queries default page size.                                   |
...
| `spring.data.cassandra.pool.max-queue-size`                  | `256.0`                      | Maximum number of requests that get queued if no connection is available. |
...
| `server.jetty.acceptors`                             | `-1.0`                                                       | Number of acceptor threads to use. When the value is -1, the default, the  number of acceptors is derived from the operating environment. |
...
| `server.jetty.max-threads`                           | `200.0`                                                      | Maximum number of threads.                                   |
| `server.jetty.min-threads`                           | `8.0`                                                        | Minimum number of threads.                                   |
| `server.jetty.selectors`                             | `-1.0`                                                       | Number of selector threads to use. When the value is -1, the default, the  number of selectors is derived from the operating environment. |
| `server.jetty.thread-idle-timeout`                   | `60000ms`                                                    | Maximum thread idle time.                                    |
...
| `server.tomcat.max-threads`                          | `200.0`                                                      | Maximum amount of worker threads.                            |
| `server.tomcat.mbeanregistry.enabled`                | `false`                                                      | Whether Tomcat's MBean Registry should be enabled.           |
| `server.tomcat.min-spare-threads`                    | `10.0`                                                       | Minimum amount of worker threads.                            |
...
| `spring.session.hazelcast.save-mode`                         |                                                              | Sessions save mode. Determines how session changes are tracked and saved to the session store. |
| `spring.session.jdbc.cleanup-cron`                           | `0 * * * * *`                                                | Cron expression for expired session cleanup job.             |
| `spring.session.jdbc.flush-mode`                             |                                                              | Sessions flush mode. Determines when session changes are written to the session store. |
| `spring.session.jdbc.initialize-schema`                      | `embedded`                                                   | Database schema initialization mode.                         |
| `spring.session.jdbc.save-mode`                              |                                                              | Sessions save mode. Determines how session changes are tracked and saved to the session store. |
...
| `spring.session.redis.save-mode`                             |                                                              | Sessions save mode. Determines how session changes are tracked and saved to the session store. |
...
| `management.metrics.distribution.sla.*`                      |                                                              | Specific SLA boundaries for meter IDs starting-with the specified name. The  longest match wins. Counters will be published for each specified  boundary. Values can be specified as a long or as a Duration value (for  timer meters, defaulting to ms if no unit specified). |
...
| `management.metrics.export.appoptics.num-threads`            | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.datadog.num-threads`              | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.dynatrace.num-threads`            | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.elastic.num-threads`              | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.humio.num-threads`                | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.influx.num-threads`               | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.kairos.num-threads`               | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.newrelic.num-threads`             | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.signalfx.num-threads`             | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.stackdriver.num-threads`          | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
...
| `management.metrics.export.wavefront.num-threads`            | `2.0`                                                        | Number of threads to use with the metrics publishing scheduler. |
